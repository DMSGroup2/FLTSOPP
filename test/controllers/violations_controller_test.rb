...
class ViolationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create violation" do
    assert_difference('Violation.count') do
      post violations_url, params: { violation: { is_arrested: @violation.is_arrested, stop_outcome: @violation.stop_outcome, violation_type: @violation.violation_type } }
    end
  ...
  test "should update violation" do
    patch violation_url(@violation), params: { violation: { is_arrested: @violation.is_arrested, stop_outcome: @violation.stop_outcome, violation_type: @violation.violation_type } }
